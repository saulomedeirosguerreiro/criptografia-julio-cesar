...
public class Answer {
	...
	public static String getJson(Answer answer) {
		Gson g = new Gson();
		return g.toJson(answer);

	}

	public static Answer get(String jsonString) {
		Gson g = new Gson();
		return g.fromJson(jsonString, Answer.class);
	}
